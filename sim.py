...
def readcols(filename):
    ...
    #print(dataset1.columns[1],type(dataset1.columns))
    fields=[]
...
def createsim():
    ...
    for i in range(len(mu)):
        std_var=random.randint(10,60)/10 # create a random standard variation
        simdata=np.random.normal(mu[i],std_var,total_num) # create 2000 for i column
